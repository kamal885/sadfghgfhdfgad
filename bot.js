...
client.user.setGame(` 4play `,"http://twitch.tv/S-F")
  console.log('')
  console.log('')
  console.log('╔[═════════════════════════════════════════════════════════════════]╗')
...
client.on("message", message => {
 if (message.content === '2help') {
  const embed = new Discord.RichEmbed()
      .setColor("#000000")
      .setDescription(`
4play ⇏ لتشغيل أغنية برابط أو بأسم
4skip ⇏ لتجاوز الأغنية الحالية
4pause ⇏ ايقاف الأغنية مؤقتا
4resume ⇏ لمواصلة الإغنية بعد ايقافها مؤقتا
4vol ⇏ لتغيير درجة الصوت 100 - 0
4stop ⇏ لإخرآج البوت من الروم
4np ⇏ لمعرفة الأغنية المشغلة حاليا
4queue ⇏ لمعرفة قائمة التشغيل
 `)
